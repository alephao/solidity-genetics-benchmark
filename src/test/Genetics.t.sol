...
contract GeneticsTest is DSTest {
    ...
    function testOnePointCrossOver() public {
        assertEq(
            Genetics.onePointCrossOver(0x11111111, 0x22222222, 0),
            0x11111122
        );
        assertEq(
            Genetics.onePointCrossOver(0x11111111, 0x22222222, 1),
            0x11112222
        );
        assertEq(
            Genetics.onePointCrossOver(0x11111111, 0x22222222, 2),
            0x11222222
        );
    }
}
